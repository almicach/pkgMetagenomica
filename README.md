...
[![GitHub
issues](https://img.shields.io/github/issues/almicach/pkgMetagenomica)](https://github.com/almicach/pkgMetagenomica/issues)
[![GitHub
pulls](https://img.shields.io/github/issues-pr/almicach/pkgMetagenomica)](https://github.com/almicach/pkgMetagenomica/pulls)
<!-- badges: end -->
...
[GitHub](https://github.com/almicach/pkgMetagenomica) with:

``` r
BiocManager::install("almicach/pkgMetagenomica")
```
...
#> 
#>   Miranda A (2022). _pkgMetagenomica: Package for metagenomics
#>   analysis_. R package version 0.99.0,
#>   <https://github.com/almicach/pkgMetagenomica>.
#> 
...
#>     url = {https://github.com/almicach/pkgMetagenomica},
#>   }
```
...
-   The [documentation
    website](http://almicach.github.io/pkgMetagenomica) is automatically
    updated thanks to
